...
- [x] Daily timeline using CSS Grid (15-min slots), mobile-first responsive.
- [x] Block cards: create/edit/delete, notes, color, tags.
- [x] Drag-and-drop + resize; snap-to-grid; collision warning UI.
- [x] Keyboard accessibility (move/resize blocks, ARIA roles for grid).
- [x] Focus/Pomodoro stub (start/stop timer UI only).
